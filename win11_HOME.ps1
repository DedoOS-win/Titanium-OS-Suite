...
& {
    ...
    Write-Host ("|  {0,-56}|" -f $Lang.SearchInfoTitle) -ForegroundColor Cyan
    Write-Host "|                                                          |" -ForegroundColor Cyan
    Write-Host ("|  {0,-56}|" -f $Lang.SearchInfoLine1) -ForegroundColor Cyan
    Write-Host ("|  {0,-56}|" -f $Lang.SearchInfoLine2) -ForegroundColor Cyan
    Write-Host "|                                                          |" -ForegroundColor Cyan
    Write-Host ("|  {0,-56}|" -f $Lang.SearchInfoLine3) -ForegroundColor Cyan
    Write-Host ("|  {0,-56}|" -f $Lang.SearchInfoLine4) -ForegroundColor Cyan
    Write-Host "|                                                          |" -ForegroundColor Cyan
    Write-Host ("|  {0,-56}|" -f $Lang.SearchInfoLine5) -ForegroundColor Cyan
    Write-Host ("|  {0,-56}|" -f $Lang.SearchInfoLine6) -ForegroundColor Cyan
    Write-Host ("|  {0,-56}|" -f $Lang.SearchInfoLine7) -ForegroundColor Cyan
    Write-Host ("|  {0,-56}|" -f $Lang.SearchInfoLine8) -ForegroundColor Cyan
    Write-Host ("|  {0,-56}|" -f $Lang.SearchInfoLine9) -ForegroundColor Cyan
    Write-Host "|                                                          |" -ForegroundColor Cyan
    Write-Host ("|  {0,-56}|" -f $Lang.SearchInfoEnter) -ForegroundColor White
    Write-Host "+----------------------------------------------------------+" -ForegroundColor Cyan
    Read-Host
...
& {
    ...
    Write-Host ("|  {0,-56}|" -f $Lang.WSearchTitle) -ForegroundColor Yellow
    Write-Host "|                                                          |" -ForegroundColor Yellow
    Write-Host ("|  {0,-56}|" -f $Lang.WSearchLine1) -ForegroundColor Yellow
    Write-Host ("|  {0,-56}|" -f $Lang.WSearchLine2) -ForegroundColor Yellow
    Write-Host ("|  {0,-56}|" -f $Lang.WSearchLine3) -ForegroundColor Yellow
    Write-Host "|                                                          |" -ForegroundColor Yellow
    Write-Host ("|  {0,-56}|" -f $Lang.WSearchOptY) -ForegroundColor Green
    Write-Host ("|  {0,-56}|" -f $Lang.WSearchOptN) -ForegroundColor Cyan
    Write-Host "+----------------------------------------------------------+" -ForegroundColor Yellow

    $risposta = Read-Host "`n$($Lang.WSearchPrompt)"
    ...
    if ($risposta -match "^[SsYy]$") {
        ...
        Write-Host "   $($Lang.WSearchDisabled)" -ForegroundColor Yellow
        Write-Host "`n+----------------------------------------------------------+" -ForegroundColor Green
        Write-Host ("|  {0,-56}|" -f $Lang.WSearchNote1) -ForegroundColor Green
        Write-Host ("|  {0,-56}|" -f $Lang.WSearchNote2) -ForegroundColor Green
        Write-Host ("|  {0,-56}|" -f $Lang.WSearchNote3) -ForegroundColor Green
        Write-Host "+----------------------------------------------------------+" -ForegroundColor Green
    } else {
        Set-ItemProperty -Path "HKLM:\SYSTEM\CurrentControlSet\Services\WSearch" -Name "Start" -Value 3 -Force
        Write-Host "   $($Lang.WSearchKept)" -ForegroundColor Green
    }
...
"@
    ...
    Write-Host "`n$($Lang.SummaryTitle)" -ForegroundColor Green
